...
class TestGroupHierarchyPermissions(APITestCase):
    ...
    def test_parent_admin_user_can_view_child_projects(self):
        """
    ...
    def test_parent_admin_user_can_create_child_projects(self):
        """
    ...
    def test_parent_admin_user_can_edit_child_projects(self):
        """
